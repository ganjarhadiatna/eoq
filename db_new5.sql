...
LOCK TABLES `barang` WRITE;
/*!40000 ALTER TABLE `barang` DISABLE KEYS */;
INSERT INTO `barang` VALUES (1,'Test 1',9,15000,400,'2021-05-23','2019-05-20 16:49:23','2019-07-04 09:48:32',2,2,2,2),(2,'Test 2',6,18000,500,'2021-12-24','2019-05-20 17:07:45','2019-07-01 12:40:08',2,1,2,2),(3,'test3',15,12000,600,'2020-08-13','2019-07-04 08:24:10','2019-07-04 12:00:30',2,1,2,2),(4,'Test 4',8,10000,500,'2020-08-14','2019-07-04 18:42:36','2019-07-04 11:43:04',2,2,2,2);
/*!40000 ALTER TABLE `barang` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `diskons` WRITE;
/*!40000 ALTER TABLE `diskons` DISABLE KEYS */;
INSERT INTO `diskons` VALUES (5,0.03,5,10,'incremental',2,'2019-06-25 19:11:13',NULL),(6,0.1,10,20,'incremental',2,'2019-06-25 19:11:29',NULL),(7,0.15,20,35,'incremental',2,'2019-06-25 19:12:01',NULL),(8,0.08,10,35,'unit',1,'2019-06-25 19:13:14','2019-07-01 09:52:14'),(9,0.05,1,19,'incremental',1,'2019-07-01 17:10:20','2019-07-01 10:55:38'),(10,0.1,20,49,'incremental',1,'2019-07-01 17:11:06','2019-07-01 10:55:47'),(11,0.15,50,100,'incremental',1,'2019-07-01 17:11:26','2019-07-01 10:55:55');
/*!40000 ALTER TABLE `diskons` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `pembelian` WRITE;
/*!40000 ALTER TABLE `pembelian` DISABLE KEYS */;
INSERT INTO `pembelian` VALUES (9,'AAA-111',15,20000,500,0.02,'2019-05-26','selesai','2019-05-26 23:33:33','2019-05-26 16:40:17',2,2,1),(18,'AAA-111',7,12000,600,0.02,'2019-07-04','selesai','2019-07-04 19:00:22','2019-07-04 12:00:30',2,3,1);
/*!40000 ALTER TABLE `pembelian` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `pemesanan` (
  ...
  `reorder_point` int(10) unsigned NOT NULL,
  `frekuensi_pembelian` double unsigned NOT NULL,
  `tipe` enum('EOQ Sederhana','Back Order','Special Order','Price Increase','Quantity Discount','Batasan Modal','Batasan Gudang') DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT NULL,
  `idusers` int(10) unsigned NOT NULL,
  `idbarang` int(10) unsigned NOT NULL,
...
LOCK TABLES `pemesanan` WRITE;
/*!40000 ALTER TABLE `pemesanan` DISABLE KEYS */;
INSERT INTO `pemesanan` VALUES (134,10000,11,70688,88081,0,0.65,'Back Order','2019-07-06 18:49:15','2019-07-06 11:49:15',2,4,2),(135,15000,17,261899,261899,1,0.99,'EOQ Sederhana','2019-07-06 18:51:12','2019-07-06 11:51:12',2,1,2);
/*!40000 ALTER TABLE `pemesanan` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `supplier` WRITE;
/*!40000 ALTER TABLE `supplier` DISABLE KEYS */;
INSERT INTO `supplier` VALUES (1,'AAA BBB','aaa@gmail.com','111222333444','jl. aaa',2,50,2000,'2019-05-14 03:42:05','2019-07-06 05:43:34',2),(2,'BBB','bbb@gmail.com','222233334444','jl. bbb',2,50,3500,'2019-05-14 04:37:18','2019-07-06 05:43:25',2);
/*!40000 ALTER TABLE `supplier` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-07-07 20:11:52
